...
namespace ItAcademy.Application.Events
{
    public interface IEventService
    {
        ...
        Task<string> AddEvent(CancellationToken token, EventRequest request, string userId);
        Task<bool> ApproveEvent(CancellationToken token, int eventId);
        Task<EventResponse> UpdateEvent(CancellationToken token, UpdateEventRequest request, int eventId, string id);
